...
namespace sospdemo {
/**
 * A serializable wrapper class for a Binary Large OBject (BLOB)
...
public:
    ...
    static std::unique_ptr<BlobWrapper> from_bytes(mutils::DeserializationManager*, const char* const buffer);
